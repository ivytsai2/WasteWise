...
def classifyWaste():
    ...
    resp = Response(json.dumps(pred_results))
    resp.headers['Origin'] = 'https://7c8y7sxwwl.appflowapp.com'
    #resp.headers['X-Requested-With'] = 'XMLHttpRequest'
...
def chat():
    ...
    resp = Response(json.dumps(reply))
    resp.headers['Origin'] = 'https://7c8y7sxwwl.appflowapp.com'
    #resp.headers['X-Requested-With'] = 'XMLHttpRequest'
